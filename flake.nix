  ...
  outputs = inputs:
    ...
    in flake-utils.lib.eachSystem supportedSystems (system:
      let
        ...
        repo = "flakeutils";
        version = "0.0.1";
        sha256 = "1hvx9sn79yqcw60kx43d8kygqiq759f2qr0hcyd1qk4grzc2zm1z";
        pname = "${org}-${repo}";
      ...
      in rec {
        apps = rec {
          ...
          pythoneda-external-artf-flakeutils-python312 = shared.app-for {
            package =
        ...
        devShells = rec {
          ...
          pythoneda-external-artf-flakeutils-python312 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python312
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-external-artf-flakeutils-python312;
          ...
          pythoneda-external-artf-flakeutils-python313 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python313
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-external-artf-flakeutils-python313;
        ...
        packages = rec {
          ...
          pythoneda-external-artf-flakeutils-python313 =
            pythoneda-external-artf-flakeutils-for {
              python = pkgs.python313;
              pythoneda-shared-nix-flake-shared =
